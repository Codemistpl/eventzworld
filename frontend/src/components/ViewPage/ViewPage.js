...
//       try {
//         const response = await fetch(`http://localhost:4113/create_post/getPostbylocation/${JSON.stringify(currentLocation)}`,{
//           method: 'GET'
//         });
//         if (!response.ok) {
...
//       </div>
//     <div className="card">
//         <label htmlFor="dateRange" style={{ fontSize: "20px", fontWeight:"500", color:"brown", paddingBottom:"6px" }}>View Events </label>
//         <select style={{ width: "30%", display: "flex", justifyContent: "center", marginTop: "6px" }} id="dateRange" value={selectedRange} onChange={handleRangeChange}>
